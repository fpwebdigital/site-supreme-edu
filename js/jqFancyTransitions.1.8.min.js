...
inc[el.id]=0;buttons=$('#ft-buttons-'+el.id).children();buttons.each(function(index){if(index==imgInc[el.id]){$(this).addClass('ft-button-'+el.id+'-active');$(this).empty();$(this).append('<img src="bt_2.png" border="0" />');}else{$(this).removeClass('ft-button-'+el.id+'-active');$(this).empty();$(this).append('<img src="bt_1.png" border="0" />');}});if(opts[el.id].direction=='random')
...
this.each(function(){init(this);});};$.fn.jqFancyTransitions.defaults={width:960,height:400,strips:10,delay:5000,stripDelay:50,titleOpacity:0.7,titleSpeed:1000,position:'alternate',direction:'fountainAlternate',effect:'',navigation:false,links:false};})(jQuery);