...
<?php
	...
	$texto = '
		<table width="600" border="0" align="center" style="border:1px solid #c2c2c2" bgcolor=" #E5E5E5">
		 <tr>
		  ...
		  <tr>
			<td align="right" width="20%"><font size="-1" face="Arial, Helvetica, sans-serif" color="#333333"><strong>Mensagem:</strong></td>
	...
	echo '<script type="text/javascript">alert("Obrigado! Em Breve Retornaremos seu Contato.");location.href="index.php";</script>';
;
?>